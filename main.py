...
def contact():
    mess._show(title='Contact us', message="Please contact us on : 'anuragparate007@gmail.com' ")
...
def getImagesAndLabels(path):
    ...
    # os.listdir is used to  to get the list of all files and directories in the specified directory
